...
const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  const notifications = [
    { id: 1, text: 'Queue update available', time: '2 hours ago', unread: true },
    { id: 2, text: '2 organizations pending your review', time: '1 day ago', unread: true },
    { id: 3, text: 'All systems operational', time: '3 days ago', unread: false }
  ];
      ...
      <div className="mx-auto max-w-full px-2 sm:px-4 lg:px-6">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <Link to={homeLink} className="group flex items-center gap-3 ml-4 lg:ml-0 transition-all duration-300 hover:scale-105">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:shadow-blue-500/25 transition-all duration-300">
                <span className="text-white font-bold text-lg">{brandAbbrev}</span>
              </div>
